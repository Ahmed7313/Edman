...
import com.daman.edman.screens.Home.BottomSheetView
...
@Composable
fun CreateRequestScreen(navHostController: NavHostController) {
        ...
        Column(
            ...
            if (showBottomSheet) {
                ModalBottomSheet(
                    ...
                    PaymentView(sheetState = sheetState, onDismiss = { showBottomSheet = false })
                }
            }
